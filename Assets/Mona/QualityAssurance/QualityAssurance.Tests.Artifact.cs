...
namespace Mona
{
    ...
    public static partial class QualityAssurance
    {
        ...
        public static void TestArtifactPlacments()
        {
            ...
            if (_badArtifacts != "")
            {
                ErrorCodes.Add(new string[] { "BAD_ARTIFACT_PLACEMENT", "The following Artifact are not placed in the ArtifactLayer: " + _badArtifacts });
            }
        }
        ...
        public static void TestArtifactTag()
        {
            ...
            if (_badArtifacts)
            {
                ErrorCodes.Add(new string[] { "BAD_ARTIFACT_TAG", "Artifact is missing it's Artifact Tag, Add it on a object that's the 3rd child of root." });
            }
        }
        ...
        public static void TestArtifactNames()
        {
            ...
            if (_badArtifact)
            {
                ErrorCodes.Add(new string[] { "BAD_ARTIFACT_NAME", "Artifact has the same name as another Artifact." });
            }
        }
        ...
        public static void TestArtifactCollider()
        {
            ...
            if (_badArtifact)
            {
                ErrorCodes.Add(new string[] { "BAD_ARTIFACT_COLLIDER", "Artifact has no collider. Or the collider is marked as trigger!" });
            }
        }
    }
}