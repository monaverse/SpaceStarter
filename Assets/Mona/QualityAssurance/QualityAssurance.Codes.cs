...
namespace Mona
{
    public static class ErrorDescriptions
    {
        ...
        // Texture Errors
        public static string TEXTURE_CRUNCH_COMPRESSION = "One or more of your textures is using crunch compression. See console for more info.";
    }
    ...
    public static class MonaErrorCodes
    {
        ...
        // Texture Errors
        public static string TEXTURE_CRUNCH_COMPRESSION = "texture.crunch-compression";
        ...
        public static Dictionary<string, string> GetErrorDescriptionMap()
        {
            return new Dictionary<string, string> {
                ...
                { MonaErrorCodes.TEXTURE_CRUNCH_COMPRESSION, ErrorDescriptions.TEXTURE_CRUNCH_COMPRESSION }
            };
        }
    }
}
